...
class Chat:
    ...
    def __init__(self, dictionary=None):
        ...
        self.regions = str(dictionary[self.__KEY_REGIONS]) if dictionary.get(self.__KEY_REGIONS) is not None else None
        self.description = str(dictionary[self.__KEY_DESCRIPTION]) if dictionary.get(self.__KEY_DESCRIPTION) is not None else None
        self.category = str(dictionary[self.__KEY_CATEGORY]) if dictionary.get(self.__KEY_CATEGORY) is not None else None
        ...
        self.invite_link = str(dictionary[self.__KEY_INVITE_LINK]) if dictionary.get(self.__KEY_INVITE_LINK) is not None else None
